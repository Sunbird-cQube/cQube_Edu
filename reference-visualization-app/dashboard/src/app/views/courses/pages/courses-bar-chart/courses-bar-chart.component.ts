...
@Component({
  ...
  templateUrl: './courses-bar-chart.component.html',
  styleUrls: ['./courses-bar-chart.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class CoursesBarChartComponent implements OnInit {
  chart: boolean = false;
  public colors = [];
  ...
  async getAllData() {
    ...
    this.service.dikshaBarChart({ collection_type: this.collection_type }).subscribe(async result => {
      ...
      this.constructDashletReport(this.result);
