import { Component, OnInit, ChangeDetectorRef, ViewChild, ElementRef, AfterViewInit, HostListener, Inject } from '@angular/core';
import { Router } from '@angular/router';
import { AppServiceComponent } from 'src/app/app.service';
import { environment } from 'src/environments/environment';
import * as _ from "lodash"
import { progressCardService } from 'src/app/core/services/core-apis/progress-card.service';
...
progressBar = document.querySelector('.progress-bar');
  ...
  stateData() {
    ...
    document.getElementById('myInput') ?  document.getElementById('myInput')['disabled'] = true : '';
    document.getElementById('myInput') ? document.getElementById('myInput')['value'] = '' : '';
