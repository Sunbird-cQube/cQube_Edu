...
@Component({
  selector: 'app-pat-heatmap',
  templateUrl: './pat-heatmap.component.html',
  styleUrls: ['./pat-heatmap.component.scss']
})
export class PatHeatmapComponent implements OnInit {
    ...
    service.PATHeatMapMetaData({ report: "pat" }).subscribe(
      (res) => {
        try {
          ...
          this.examDates = [
            { exam_date: "all" },
            ...this.examDates.filter((item) => item),
          ];
