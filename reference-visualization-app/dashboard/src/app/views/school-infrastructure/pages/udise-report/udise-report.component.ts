...
@Component({
  ...
  styleUrls: ['./udise-report.component.scss']
})
export class UdiseReportComponent implements OnInit, AfterViewInit {
      ...
      this.myData = this.service.udise_block_wise({ management: this.management, category: this.category }).subscribe(
        (res: any) => {
          if (this.districtSelected) {
            ...
            this.data = this.myBlockData = res.result.data;
            this.gettingIndiceFilters(this.data);
