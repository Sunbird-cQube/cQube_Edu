...
export class InfraMapComponent implements OnInit, AfterViewInit {
    ...
    constructor(
      ...
      this.commonService.callProgressCard.subscribe((value:any) => {
        if (value) {
    ...
    // google maps
    mouseOverOnmaker(infoWindow: any, $event: MouseEvent): void {
      infoWindow.open();
    }
  
    mouseOutOnmaker(infoWindow: any, $event: MouseEvent) {
      infoWindow.close();
    }
