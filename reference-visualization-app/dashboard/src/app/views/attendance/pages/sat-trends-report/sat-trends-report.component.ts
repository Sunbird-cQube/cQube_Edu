...
@Component({
  selector: 'app-sat-trends-report',
  templateUrl: './sat-trends-report.component.html',
  styleUrls: ['./sat-trends-report.component.scss']
})
export class SatTrendsReportComponent implements OnInit {

  @Output() switchToAttendance = new EventEmitter<any>();

  routeToAttendance() {
    this.switchToAttendance.emit();
  }
