...
@Component({
  selector: 'app-vidyanjali',
  templateUrl: './vidyanjali.component.html',
  styleUrls: ['./vidyanjali.component.scss']
})
export class VidyanjaliComponent implements OnInit {
  vidyanjaliMetricsData: any;
  vidyanjaliStateData: any;

  constructor() { 
    this.getVidyanjaliMetricsData();
    this.getvidyanjaliStateData();
  }
  ...
  getvidyanjaliStateData(): void {
      this.vidyanjaliStateData = [
        {
